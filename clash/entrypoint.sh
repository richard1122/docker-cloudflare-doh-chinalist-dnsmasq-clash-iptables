...
iptables -t nat -D OUTPUT -j CLASH_OUTPUT

iptables -t nat -N CLASH
iptables -t nat -F CLASH
iptables -t nat -A CLASH -p tcp -j REDIRECT --to-ports 7892
iptables -t nat -A CLASH -p udp -d 114.114.115.115 -j RETURN
...
iptables -t nat -A CLASH_OUTPUT -m owner --uid-owner 900 -j RETURN
